...
<div style="background-color:#ffffff;" class="container margin_60">
	...
	<section id="section-1">
		<div class="indent_title_in">
			...
			<p>Antes de preencher cadastre-se no  <a href="https://mercadopago.com.br/">mercadopago.com.br</a> caso queira receber </p>
		   <p> de seus clientes a opção de pagamentos ONLINE. </p>
		<p>*****************************************************************</p>
              <p> DEPOIS DE CRIAR SUA CONTA NO MERCADO PAGO VOCÊ DEVE</p>
             <p>  TERMINAR DE PREENCHER ALGUNS DADOS E PEGAR O CÓDIGO DO  </p>
           <p>    "ACESS TOKEN" INFORMADO NO LINK ABAIXO:</p>
        <p>        <a href="https://www.mercadopago.com.br/developers/panel/credentials">https://www.mercadopago.com.br/developers/panel/credentials</a> </p>
      <p>         Entre em " credenciais de produção ":</p>
<p>       ******************************************************************</p>
<p>               PARA QUE AS ALTERAÇÕES SEJAM SALVAS, FAVOR NÃO DEIXAR O ACESS TOKEN EM BRANCO!</p>
<p>               CASO NÃO QUEIRA RECEBER ONLINE, NA ABA "TIPO DE PAGAMENTO" COLOQUE A OPÇÃO</p>
<P>               "PAGAR SOMENTE NA ENTREGA" E COLOQUE QUAQUER LETRA OU NÚMERO NA CAIXA DE "ACESS TOKEN" E SALVE.</P>
<p>               DEPOIS QUE CLICAR EM "SALVAR CONFIGURAÇÕES", A PÁGINA IRA ATUALIZAR 2 VEZES, É SÓ AGUARDAR ATÉ AS</P>
<P>               CONFIGURAÇÕES SEREM APLICADAS NO SISTEMA</p>
			</p>
		</div>				
...
<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">×</button>
Preencha todos os campos, (PARA SALVAR AS ALTERAÇÕES VOCÊ PRECISA PREENCHER O ACESS TOKEN) !
</div>";
header("Refresh: 5; url={$site}{$Url[0]}/admin-loja");
...
<div class="panel-group" id="accordion">
	...
	<div class="indent_title_in">
		...
		<p>Caso queira receber somente na entrega</p>
		<p>Marque o tipo de pagamento: "pagar somente na entrega"</p>
	</div>
	...
	<div class="wrapper_indent">
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					<label for="facebook_empresa">Access Token:</label> APAGUE A MENSAGEM ABAIXO E COLE O SEU ACESS TOKEN!
					<input type="text" placeholder="Insira seu token de acesso" class="form-control" value="
					<?=(!empty($access_token_mp) ? $access_token_mp : "COLE AQUI O SEU ACESS TOKEN DO MERCADO PAGO");?>" name="access_token_mp" >
				</div>
			</div>
		</div>
	</div><!-- End wrapper_indent -->
